...
$table = $installer->getConnection()->newTable($installer->getTable('zefir_dealers/dealer'))
                  ...
                  ->addColumn('location_lat',Varien_Db_Ddl_Table::TYPE_FLOAT, 10, array('signed' => true,'nullable' => true), 'Latitude')
                  ->addColumn('location_lng',Varien_Db_Ddl_Table::TYPE_FLOAT, 10, array('signed' => true,'nullable' => true), 'Longitude');
