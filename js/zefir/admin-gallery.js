DealerGallery = Class.create();
DealerGallery.prototype = {
  ...
  updateImages : function() {
      ...
      if (this.images.length > 0) {
          //hide first tow with no recordes info
          $(this.containerId + '-no-images').hide();
      }
      else {
          $(this.containerId + '-no-images').show();
      }
  ...
  updateImage : function(file) {
      ...
      this.images[index].description = this.getFileElement(file, 'cell-description input').value;
  ...
  updateVisualisation : function(file) {
      ...
      this.getFileElement(file, 'cell-description input').value = image.description;
